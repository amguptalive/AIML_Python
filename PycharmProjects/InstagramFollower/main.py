...
SIMILAR_ACCOUNT = "dareaab_by_soniakmahajan"
USERNAME = "kunj281218"
PASSWORD = "ShriGuru2023"
...
class InstaFollower:
    ...
    def find_followers(self):
        ...
        #
        # modal_xpath = "/html/body/div[6]/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div[2]"
        ...
        self.driver.get(f"https://www.instagram.com/{SIMILAR_ACCOUNT}/followers")
        time.sleep(4)
        follower = self.driver.find_element(By.CSS_SELECTOR, f'a[href="/{SIMILAR_ACCOUNT}/followers/"]')
        follower.click()
        time.sleep(2)
    def follow(self):
